...
CREATE TABLE `flashcards` (
  ...
  CONSTRAINT `flashcards_set_set_id_fk` FOREIGN KEY (`set_id`) REFERENCES `set` (`id`)
...
INSERT INTO `set` VALUES (1,'IT','Java','Basic Java question'),(2,'Chemistry','Science','High school Chemistry questions'),(3,'Algebra','Mathematics','High school Mathematics'),(4,'geography','geography','Elementary geography questions');
